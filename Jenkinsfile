...
node('maven') {
  ...
  def nexusReleaseURL = "http://nexus3.rhdm-tools.svc.cluster.local:8081/repository/releases"
  def mavenRepoURL = "http://nexus3.rhdm-tools.svc.cluster.local:8081/repository/maven-all-public/"
